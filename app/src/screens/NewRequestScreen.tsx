...
function PickupStep({ state, draft, setDraft, cityConfig }: { state: AppState; draft: Draft; setDraft: (d: Draft) => void; cityConfig: CityConfig }) {
  return (
...
function DropoffStep({ state, draft, setDraft, cityConfig }: { state: AppState; draft: Draft; setDraft: (d: Draft) => void; cityConfig: CityConfig }) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <Field
        label="Receiver name"
  ...
  return (
    <div className="cs-screen cs-enter-right">
      ...
      <div style={{ flex: 1, padding: '0 20px', overflowY: 'auto', scrollbarWidth: 'none', overflowX: 'visible' }}>
        {stepIdx === 0 && <PickupStep state={state} draft={draft} setDraft={setDraft} cityConfig={cityConfig} />}
        {stepIdx === 1 && <DropoffStep state={state} draft={draft} setDraft={setDraft} cityConfig={cityConfig} />}
